% Modified "ukf_update1" in ekfukf toolbox to get the modified UKF method
...
function [M,P,K,MU,S,LH] = ukf_update1_modified(M,P,Y,h,R,h_param,alpha,beta,kappa,mat)
  ...
  [MU,S,C] = ut_transform_modified(M,P,h,h_param,tr_param);
