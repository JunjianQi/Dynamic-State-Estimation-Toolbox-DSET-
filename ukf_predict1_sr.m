% Modified "ukf_predict1" in ekfukf toolbox to get the square-root UKF method
...
function [M,P,D] = ukf_predict1_sr(M,P,f,Q,f_param,alpha,beta,kappa,mat)
  ...
  [M,P] = ut_transform_sr(M,P,f,f_param,tr_param,Q);
